myData_PRISM <- function(data.type = c("E","E_rnaseq","EL"),drug.type = c("ActArea","IC50")){
  ...
  myActArea<-function(){
    load("/gpfs/archive/RED/isjang/Project_CC90009/PRISM/Celgene_AUC_decoded_jis.rdata")
    adf_drug <- PRISM.auc
    return(adf_drug)
  }
  myIC50<-function(){
